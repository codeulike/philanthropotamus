namespace Wwwtw.Web.Mvc.CastleWindsor
{
    ...
    public class ComponentRegistrar
    {
        ...
        private static void AddTasksTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("Wwwtw.Tasks")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("Wwwtw.Domain"));
        }
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container) 
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("Wwwtw.Infrastructure")
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("Wwwtw.Web.Mvc")
                    .BasedOn<NHibernateQuery>()
                    .WithService.DefaultInterfaces());

            container.Register(
                AllTypes.FromAssemblyNamed("Wwwtw.Infrastructure")
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("Wwwtw.Tasks")
